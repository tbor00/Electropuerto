		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['success']) {
					...
					setTimeout(function () {
						$('#wishlist').html('<button type="button" data-toggle="tooltip" title="Eliminar de Favoritos" onclick="wishlist.remove(\'' + product_id + '\');"><i class="fa fa-star" style="color:orange"></i></button>');
		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['success']) {
					$('#wishlist > button').tooltip("destroy");
					setTimeout(function () {
						$('#wishlist').html('<button type="button" data-toggle="tooltip" title="Agregar a Favoritos" onclick="wishlist.add(\'' + product_id + '\');"><i class="fa fa-star"></i></button>');
						$('#wishlist > button').tooltip();
					}, 100);
				}
