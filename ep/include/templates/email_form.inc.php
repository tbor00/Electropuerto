...
if ($_POST['oc']=="sndmail"){
	...
	$captcha = json_decode(file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret=$default->captcha_secret&response='.$_POST['g-recaptcha-response'].'&remoteip='.$_SERVER['REMOTE_ADDR']),TRUE); 
...
<?php
echo recaptcha_get_html($default->captcha_site_key, $error_captcha, true);
?>
</div>
</div>
</fieldset>
