  ...
  <div class="container">
	...
	<div id="top-links" class="nav pull-right">
      <ul class="list-inline">
        <li class="dropdown"><a href="" title="Perfil" class="dropdown-toggle" data-toggle="dropdown" style="color:red"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $_SESSION["user_alias"]; ?></span> <span class="caret"></span></a>
