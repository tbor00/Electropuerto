...
$site_config->web_title				= ".: ELECTROPUERTO :.";					                        // Titulo del sitio (defecto)
$site_config->keywords				= "materiales electricos, electricidad, gremio, meteriales, ";		// Keywords (defecto)
$site_config->copyright				= "Copyright 2017 - ELECTROPUERTO";									// Copyright
$site_config->site_description		= "ELECTROPUERTO";							                        // Descripción
$site_config->author				= "Argxentia (http://www.argxentia.com.ar)";						// Autor del sitio

//---------------------------------------------
// VARIAS
//---------------------------------------------
$site_config->mailfrom 				= "info@electropuerto.com.ar";				// Remitente de Mails (defecto)
$site_config->mailfromname			= "ELECTROPUERTO";							// Remitente de Mails (defecto)
$site_config->mailto   				= "info@electropuerto.com.ar";				// Destinatario de Mails (defecto)
$site_config->mailer   				= "mail";									// metodo para enviar mails
$site_config->session_name			= "SESSEELECTEP";							// Nombre de la SESSION
